...
<head>
<meta charset="UTF-8">
<title>Mini Bar Menu</title>
<link rel="stylesheet" href="minibar_menu.css">
...
<div class="overlay">
    <div class="container">
        ...
        <?php if(empty($items)): ?>
            <p class="empty-msg">No items found in the Mini Bar.</p>
        <?php else: ?>
                    ...
                    <div class="menu-item">
                        <div class="item-image">
                            <?php if($item['filename']): ?>
                                <img src="../uploads/<?php echo $item['filename']; ?>" alt="<?php echo $item['item_name']; ?>">
                            <?php else: ?>
