...
<body class="min-h-screen bg-gradient-to-tr from-indigo-100 via-purple-100 to-pink-100 flex items-center justify-center p-6">
  <div class="flex flex-col items-center space-y-6">
    <h1 class="text-3xl font-extrabold text-gray-800 mb-4">Restaurant/Buffet</h1>
    <div class="inline-flex rounded-full shadow-lg bg-white">
     ...
     <a href="in-roomservice.php">  <span>in-room order</span> </a>
      </button>
      <button
      ...
      >
        ...
        <a href="diningorder.php">  <span>Dining Order</span> </a>
