<?php
session_start();
require_once __DIR__ . '/../../inventory/db.php';
...
<body>
	...
	<div class="container" style="max-width:1330px;margin:20px auto;background:#121212;color:#fff;padding:20px;border-radius:12px;border:1px solid rgba(255,255,255,0.12)">
		<h3>Recent Sales</h3>
