    ...
    <main class="main-content" role="main">
      ...
      <section id="loyalty" class="section" aria-labelledby="loyalty-heading" hidden>
        ...
        <div class="stats-grid" id="loyalty-stats">
          <div class="stat-card">
            <div class="stat-header">
              <div class="stat-icon blue">👥</div>
              <span class="stat-change positive" id="growthMembers">+0%</span>
            </div>
          ...
          <div class="stat-card">
            <div class="stat-header">
              <div class="stat-icon purple">⭐</div>
              <span class="stat-change positive" id="growthPoints">+0%</span>
            </div>
          ...
          <div class="stat-card">
            <div class="stat-header">
              <div class="stat-icon green">🎁</div>
              <span class="stat-change positive" id="growthRewards">+0%</span>
            </div>
          ...
          <div class="stat-card">
            <div class="stat-header">
              ...
              <span class="stat-change positive" id="growthRevenue">+0%</span>
            </div>
      ...
      <section id="complaints" class="section" aria-labelledby="complaints-heading" hidden>
        ...
        <div class="feedback-tabs">
          <button onclick="currentComplaintType='all'; renderComplaints();" class="tab-btn active">
            All Complaints
          </button>
          <button onclick="currentComplaintType='pending'; renderComplaints();" class="tab-btn">
            Pending
          </button>
          <button onclick="currentComplaintType='in-progress'; renderComplaints();" class="tab-btn">
            In Progress
          </button>
          <button onclick="currentComplaintType='resolved'; renderComplaints();" class="tab-btn">
            Resolved
          </button>
        </div>
